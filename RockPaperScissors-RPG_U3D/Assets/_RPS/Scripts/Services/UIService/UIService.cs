...
{
	/// <summary>
	/// Servicio que indexa todos los UIController del GameObject hijo y los expone por tipo.
	/// </summary>
    ...
    public class UIService : ServiceSubscriber<UIService>
	{
        ...
        /// <summary>Devuelve el UIController del tipo T, buscando también subtipos si no hay coincidencia exacta.</summary>
		...
		/// <summary>Devuelve el UIController asociado al menú de ciudad indicado.</summary>
