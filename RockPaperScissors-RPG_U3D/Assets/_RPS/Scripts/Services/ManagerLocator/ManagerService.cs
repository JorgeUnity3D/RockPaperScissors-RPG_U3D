...
{
	/// <summary>
	/// Servicio que indexa todos los BaseManager del GameObject hijo y los expone por tipo o por TownMenu.
	/// </summary>
	...
	public class ManagerService : ServiceSubscriber<ManagerService>
	{
		...
		/// <summary>Devuelve el manager asociado al menú de ciudad indicado.</summary>
