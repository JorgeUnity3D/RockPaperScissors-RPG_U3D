...
{
	/// <summary>
	/// HUD persistente dentro de un edificio. Muestra nombre, nivel, progreso y NPC del edificio activo; botón Back emite OnBackFromTownMenu.
	/// </summary>
	public class InMenuUIController : UIController
	{
		...
		/// <summary>Rellena el HUD con los datos del edificio activo.</summary>
