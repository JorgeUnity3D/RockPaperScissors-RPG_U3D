...
{
	/// <summary>
	/// Botón de entrenamiento individual que muestra el icono de la estadística, sus barras de nivel y el overlay de selección activa.
	/// </summary>
	public class TrainingButton : MonoBehaviour
	{
		...
		/// <summary>Configura icono, nivel, overlay y listener del botón con los datos del modificador.</summary>
