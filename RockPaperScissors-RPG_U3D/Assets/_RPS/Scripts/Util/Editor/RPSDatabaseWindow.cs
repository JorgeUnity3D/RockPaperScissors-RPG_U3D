...
namespace Kapibara.Util.Editor
{
	public class RPSDatabaseWindow : EditorWindow
	{
		...
		private static readonly AssetCategory[] s_categories =
		{
			...
			new AssetCategory { Group = "LEVELS",  Label = "Combat Steps",   AssetType = typeof(CombatStepScrObj),         Folder = "Levels/Steps", DefaultName = "CombatStep"         },
			new AssetCategory { Group = "LEVELS",  Label = "Treasure Steps", AssetType = typeof(TreasureStepScrObj),       Folder = "Levels/Steps", DefaultName = "TreasureStep"       },
			new AssetCategory { Group = "LEVELS",  Label = "NPC Rescue",     AssetType = typeof(NpcRescueScrObj),          Folder = "Levels/Steps", DefaultName = "NpcRescueStep"      },
